//final with/Users/bhavinvashisth/Downloads/8x8x8 LED Matrix Cube.ino esp32 and not rtc needed
#include <WiFi.h>
#include <time.h>
#include "SevenSegment.h"

const char *ssid = "Vashisth 4G";       // Name of the Wifi Network
const char *password = "Orange@1234"; // Password of the Wifi Network
